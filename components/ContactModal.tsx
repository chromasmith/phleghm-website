...
const socialLinks = [
  { 
    platform: 'TikTok', 
    url: 'https://www.tiktok.com/@phlegmssg', 
    isPrimary: true,
    icon: (
  ...
  { 
    platform: 'YouTube', 
    url: 'https://www.youtube.com/@PHLEGMO',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
  ...
  { 
    platform: 'Instagram', 
    url: 'https://www.instagram.com/phlegmssg/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
  ...
  { 
    platform: 'Spotify', 
    url: 'https://open.spotify.com/artist/3brB4yhi4ZJtxQkbZX0wkk',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
  ...
  { 
    platform: 'SoundCloud', 
    url: 'https://soundcloud.com/phlegmo',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
...
const bookingInfo = {
  email: 'booking@phlegm.com',
  phone: null,
  manager: null,
  notes: 'For booking inquiries, collaborations, and press.',
};
